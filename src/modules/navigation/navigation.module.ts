...
import { DashboardHeadReportsComponent } from './components/dashboard-head-reports/dashboard-head-reports.component';
import { DashboardHeadDetailsComponent } from './components/dashboard-head-details/dashboard-head-details.component';
...
@NgModule({
    ...
    declarations: [
        ...
        DashboardHeadReportsComponent,
        DashboardHeadDetailsComponent,
    ],
    exports: [
        ...navigationContainers.containers,
        ...navigationComponents.components,
